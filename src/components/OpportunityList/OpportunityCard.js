...
function OpportunityCard({ opportunity, darkMode }) {
  ...
  return (
    <div className={`${
    ...
    } shadow-lg rounded-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 flex flex-col md:flex-row h-auto md:h-40`}>
      ...
      <div className="flex-1 p-4 flex flex-col justify-between">
        ...
        <div className={`border-t ${darkMode ? 'border-gray-700' : 'border-gray-200'} pt-4 relative`}>
